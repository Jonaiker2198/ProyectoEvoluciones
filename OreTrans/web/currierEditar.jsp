    ...
    <div id="proveedor">
        ...
        <div class="container">
            ...
            <form action="" method="post">
                ...
                <div class="form-row">
                    <input type="button" class="btnSalir btn btn-danger" onclick="location.href='currier.jsp'" value="Atras"/>
                </div>
        ...
        if(request.getParameter("btnActualizar")!=null){
            ...
            sta.executeUpdate("update currier set razon_social='"+razon+"',ruc='"+ruc+"',telefono='"+cel+"',direccion='"+dir+"',correo='"+cor+"',representante='"+rep+"' where id='"+id+"'");
